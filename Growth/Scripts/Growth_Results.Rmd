...
```{r}
growth%>%mutate(full.growth.rate = (full.growth / day1.SA) / 19,
                pt1.growth.rate = (pt1.growth / day1.SA) / 9,
                pt2.growth.rate = (pt2.growth / day1.SA) / 9)%>%left_join(sample.info, by = "coral_id") -> growth1.normal
...
```{r}
growth%>%mutate(full.growth.rate = (full.growth / final.SA) / 19,
                pt1.growth.rate = (pt1.growth / final.SA) / 9,
                pt2.growth.rate = (pt2.growth / final.SA) / 9)%>%left_join(sample.info, by = "coral_id") -> growth2.normal
