...
beep<- anova(full.filtered, type = 3) 
...
figure_2<- ggplot(meangrowthrate, aes(x = temp, y = Mean, colour = temp, fill = temp))+
  facet_wrap(~wound, labeller = labeller(wound = c("0" = "No Injury", "1" = "Fragmentation", "2" = "Abrasion")))+
...
xlab(expression("Temperature"))+
  ylab(expression(paste("Growth Rate (mg/cm2/day)")))+
...
# ggsave("figure_2.png", plot = figure_2, path = here(),
#        width = 8,
#        height = 8,
#        units = "in")
```
